...
public sealed class Bootstrapper
{
    public MainWindow CreateMainWindow()
    {
        ...
        var browserPanelHlsService = new BrowserPanelHlsService(browserSnapshotService, browserAudioCaptureService);
        var appUpdateManifestService = new AppUpdateManifestService();
        var appUpdatePreferenceStore = new AppUpdatePreferenceStore();
        var webRtcPublisherService = new LocalWebRtcPublisherService(browserSnapshotService, browserAudioCaptureService, browserAudioHlsService, browserPanelHlsService, appUpdatePreferenceStore);
